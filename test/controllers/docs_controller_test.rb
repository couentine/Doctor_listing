...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { name: @doc.name, speciality: @doc.speciality, zipc: @doc.zipc } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { name: @doc.name, speciality: @doc.speciality, zipc: @doc.zipc } }
